                ...
                <div className="container">
                    <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
                        <div>
                            <div className="lg:w-[570px]">
                                ...
                                <p className="text__para">
                                    we offer superior care with the latest technology and expert specialists. Our advanced treatments and cutting-edge diagnostics set us apart, ensuring you receive exceptional healthcare tailored to your needs. Choose us for a commitment to innovation and excellence.
                                </p>
                        ...
                        <div className="flex gap-[30px] justify-end">
                            <div>
                                <img className="full" src={heroImg01} alt="" />
                            </div>
