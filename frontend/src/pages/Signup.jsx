...
const Signup = () => {
    ...
    // Restriction for name
    const validateFullName = (event) => {
        const input = event.target;
        const value = input.value;
        // Regex to allow capitalized names with spaces and hyphens
        const regex = /^[A-Z][a-zA-Z\-]*(?: [A-Z][a-zA-Z\-]*)*$/; // Allows single or multiple capitalized words
        if (!regex.test(value)) {
            input.setCustomValidity("Full Name must start with a capital letter and can include spaces and hyphens.");
        } else {
                    ...
                    <div className="rounded-l-lg lg:pl-16 py-10">
                        ...
                        <form onSubmit={submitHandler}>
                            ...
                            <div className="mb-5 flex items-center gap-3">
                                { selectedFile && (<figure className="w-[60px] h-[60px] rounded-full border-2 border-solid border-primaryColor flex items-center justify-between">
