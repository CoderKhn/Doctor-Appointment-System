...
const Profile = ({doctorData}) => {
    ...
    const addQualification = e => {
        ...
        addItem("qualifications", {
            ...
            endingDate: "",
            degree: "PHD",
            university: "Delhi Medical College",
        });
    };
            ...
            <form>
                ...
                <div className="mb-5">
                    <div className="grid grid-cols-3 gap-5 mb-[30px] ">
                        ...
                        <div>
                            ...
                            <input type="number" placeholder="500" name="ticketPrice" value={formData.ticketPrice} className="form__input" onChange={handleInputChange} />
                        </div>
                    </div>
                </div>
                ...
                <div className="mb-5">
                    ...
                    <button
                        ...
                        className="bg-[#000] py-2 px-5 rounded text-white h-fit cursor-pointer">Add Qualification</button>
                </div>
                ...
                <div className="mb-5">
                    ...
                    className="bg-[#000] py-2 px-5 rounded text-white h-fit cursor-pointer">Add Experience</button>
                </div>
                ...
                <div className="mb-5">
                        ...
                        <div key={index}>
                            <div>
                                <div className="grid grid-cols-2 md:grid-cols-4 mb-[30px] gap-5">
                                    ...
                                    <div onClick={e=> deleteTimeSlot(e, index)} 
                    ...
                    <button
                     onClick={addTimeSlot}
                    className="bg-[#000] py-2 px-5 rounded text-white h-fit cursor-pointer">Add TimeSlot</button>
                </div>
                <div className="mb-5">
                    <p className="form__label">About*</p>
                    <textarea name="about" rows={5} value={formData.about} placeholder="Wrtie about you" onChange={handleInputChange} className="form__input"></textarea>
                </div>
                <div className="mb-5 flex items-center gap-3">
                    {formData.photo && (<figure className="w-[60px] h-[60px] rounded-full border-2 border-solid border-primaryColor flex items-center justify-between">
